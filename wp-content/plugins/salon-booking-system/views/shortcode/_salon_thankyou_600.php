...
<?php if (in_array($plugin->getBookingBuilder()->getLastBooking()->getStatus(), array(SLN_Enum_BookingStatus::PAID, SLN_Enum_BookingStatus::CONFIRMED)) && $plugin->getBookingBuilder()->getLastBooking()->getAmount() > 0.0): ?>
